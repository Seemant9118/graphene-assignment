...
import Star from '../../asserts/Star 3.png';

const Hero = () => {
    return (
        <div className='Hero'>
            <div className='Hero-Title'>
                <div className='FRESH'><h1>Fresh</h1></div>
                <div className='YEAR'><h1>2022</h1></div>
                <div className='LOOK'><h1>Look</h1></div>
                <span>See more <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
            ...
            <div className='Hero-Container'>
                ...
                <img className="starImage" src={Star} alt="StarImage" />
                <img className="HeroImage" src={HeroImage} alt='ThisisanImage' />
